...
/** Record of type About (about) */
export type AboutRecordContentArgs = {
...
export type LogListModelFilter = {
  OR?: InputMaybe<Array<InputMaybe<LogListModelFilter>>>;
  _createdAt?: InputMaybe<CreatedAtFilter>;
  _firstPublishedAt?: InputMaybe<PublishedAtFilter>;
  _isValid?: InputMaybe<BooleanFilter>;
  _publicationScheduledAt?: InputMaybe<PublishedAtFilter>;
...
export type LogListRecord = RecordInterface & {
  __typename?: "LogListRecord";
  _createdAt: Scalars["DateTime"];
  _firstPublishedAt?: Maybe<Scalars["DateTime"]>;
  _isValid: Scalars["BooleanType"];
  _modelApiKey: Scalars["String"];
...
/** Record of type Logs (log_list) */
export type LogListRecord_SeoMetaTagsArgs = {
  locale?: InputMaybe<SiteLocale>;
};
...
/** Record of type Now (now) */
export type NowRecord = RecordInterface & {
  __typename?: "NowRecord";
  _createdAt: Scalars["DateTime"];
  _firstPublishedAt?: Maybe<Scalars["DateTime"]>;
  _isValid: Scalars["BooleanType"];
  _modelApiKey: Scalars["String"];
...
/** Record of type Now (now) */
export type NowRecord_SeoMetaTagsArgs = {
  locale?: InputMaybe<SiteLocale>;
};

/** Record of type Now (now) */
export type NowRecordContentArgs = {
  markdown?: InputMaybe<Scalars["Boolean"]>;
};
...
/** The query root for this schema */
export type QueryAllLogListsArgs = {
  fallbackLocales?: InputMaybe<Array<SiteLocale>>;
  filter?: InputMaybe<LogListModelFilter>;
  first?: InputMaybe<Scalars["IntType"]>;
  locale?: InputMaybe<SiteLocale>;
  orderBy?: InputMaybe<Array<InputMaybe<LogListModelOrderBy>>>;
  skip?: InputMaybe<Scalars["IntType"]>;
};
...
export type WorkModelFilter = {
  ...
  createdAt?: InputMaybe<CreatedAtFilter>;
  date?: InputMaybe<DateFilter>;
  deployment?: InputMaybe<StringFilter>;
  excerpt?: InputMaybe<StringFilter>;
  id?: InputMaybe<ItemIdFilter>;
  image?: InputMaybe<FileFilter>;
  slug?: InputMaybe<SlugFilter>;
  technologyUsed?: InputMaybe<StringFilter>;
  title?: InputMaybe<StringFilter>;
  updatedAt?: InputMaybe<UpdatedAtFilter>;
};
...
export enum WorkModelOrderBy {
  ...
  DateAsc = "date_ASC",
  DateDesc = "date_DESC",
  DeploymentAsc = "deployment_ASC",
  DeploymentDesc = "deployment_DESC",
  ExcerptAsc = "excerpt_ASC",
  ExcerptDesc = "excerpt_DESC",
  IdAsc = "id_ASC",
  IdDesc = "id_DESC",
  TechnologyUsedAsc = "technologyUsed_ASC",
  TechnologyUsedDesc = "technologyUsed_DESC",
  TitleAsc = "title_ASC",
  TitleDesc = "title_DESC",
}
...
export type WorkRecord = RecordInterface & {
  ...
  createdAt: Scalars["DateTime"];
  date?: Maybe<Scalars["Date"]>;
  deployment?: Maybe<Scalars["String"]>;
  excerpt?: Maybe<Scalars["String"]>;
  id: Scalars["ItemId"];
  image?: Maybe<FileField>;
  slug?: Maybe<Scalars["String"]>;
  technologyUsed?: Maybe<Scalars["String"]>;
  title?: Maybe<Scalars["String"]>;
  updatedAt: Scalars["DateTime"];
};
...
/** Record of type Work (work) */
export type WorkRecordAboutArgs = {
  markdown?: InputMaybe<Scalars["Boolean"]>;
};
...
export type HomeQueryQuery = {
  ...
  allLogLists: Array<{ __typename?: "LogListRecord"; content?: string | null; date?: string | null }>;
};

export type AllBlogQueryVariables = Exact<{ [key: string]: never }>;

export type AllBlogQuery = {
  __typename?: "Query";
  allBlogs: Array<{
    __typename?: "BlogRecord";
    title?: string | null;
...
export type AllworkQueryVariables = Exact<{ [key: string]: never }>;

export type AllworkQuery = {
  __typename?: "Query";
  allWorks: Array<{
    __typename?: "WorkRecord";
    title?: string | null;
...
export type SingleWorkQueryVariables = Exact<{
  slug?: InputMaybe<Scalars["String"]>;
}>;

export type SingleWorkQuery = {
  __typename?: "Query";
  work?: {
    __typename?: "WorkRecord";
    date?: string | null;
        ...
        selections: [
          {
            ...
            arguments: [
              ...
              },
              {
                ...
                value: { kind: "StringValue", value: "2", block: false },
              },
            ],
            selectionSet: {
              kind: "SelectionSet",
          ...
          },
          {
            ...
            arguments: [
              ...
              },
              {
                kind: "Argument",
                name: { kind: "Name", value: "first" },
                value: { kind: "StringValue", value: "3", block: false },
              },
            ],
            selectionSet: {
              kind: "SelectionSet",
          ...
          {
            kind: "Field",
            name: { kind: "Name", value: "allLogLists" },
            arguments: [
              {
                kind: "Argument",
                name: { kind: "Name", value: "orderBy" },
...
export const AllBlogDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "AllBlog" },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
          {
...
} as unknown as DocumentNode<AllBlogQuery, AllBlogQueryVariables>;
export const AllworkDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "Allwork" },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
          {
...
} as unknown as DocumentNode<AllworkQuery, AllworkQueryVariables>;
export const SingleBlogDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "SingleBlog" },
      variableDefinitions: [
        {
...
} as unknown as DocumentNode<SingleBlogQuery, SingleBlogQueryVariables>;
export const SingleWorkDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "SingleWork" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "slug" } },
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                { kind: "Field", name: { kind: "Name", value: "slug" } },
                { kind: "Field", name: { kind: "Name", value: "title" } },
                { kind: "Field", name: { kind: "Name", value: "technologyUsed" } },
                {
                  kind: "Field",
                  name: { kind: "Name", value: "image" },
                  selectionSet: {
...
} as unknown as DocumentNode<SingleWorkQuery, SingleWorkQueryVariables>;
export const NowPageDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "NowPage" },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
          {
...
} as unknown as DocumentNode<NowPageQuery, NowPageQueryVariables>;
